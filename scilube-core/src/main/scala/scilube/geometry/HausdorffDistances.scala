...
class HausdorffDistances[T : Ordering](distanceFn: (LabeledDoublePoint2D, LabeledDoublePoint2D) => T)
        extends ((Iterable[LabeledDoublePoint2D], Iterable[LabeledDoublePoint2D]) => 
                (Seq[PointPair[T]], Seq[PointPair[T]])) {
     ...
     */
    def apply(aa: Iterable[LabeledDoublePoint2D], bb: Iterable[LabeledDoublePoint2D]): 
            (Seq[PointPair[T]], Seq[PointPair[T]]) = {
