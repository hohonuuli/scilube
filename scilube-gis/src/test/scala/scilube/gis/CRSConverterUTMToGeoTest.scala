...
class CRSConverterUTMToGeoTest extends FunSpec with ShouldMatchers {
  ...
  describe("Geographic (WGS84) to UTM Zone 10N coordinate reference system conversion") {
    ...
    it("should calculate the position correctly") {
      ...
      longitude should be (-123.0 plusOrMinus 0.001)
      latitude should be (42.0 plusOrMinus 0.001)
    }
